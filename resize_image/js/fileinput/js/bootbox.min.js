...
//bookshop 以下为解压文件2017年8月24日 qupengkun
!
function(a, b) {
	"use strict";
...
function a(b, c) {
	...
	p.dialog = function(a) {
		...
		"static" !== a.backdrop && d.on("click.dismiss.bs.modal",
		function(a) {
		...
		d.on("click", ".bootbox-close-button",
		function(a) {
			e(a, d, l.onEscape)
		}),
		d.on("keyup",
	...
	return p.addLocale = function(a, c) {
		return b.each(["OK", "CANCEL", "CONFIRM"],
		function(a, b) {
	...
	p.setLocale = function(a) {
		return p.setDefaults("locale", 'zh_CN')
	},
	p.init = function(c) {
		return a(c || b)
	},
	p
});bootbox.setLocale("zh_CN");//弹框提示信息为中文